...
\begin{frame}{Interprétation abstraite}
    L'\textbf{interprétation abstraite} permet de déterminer des propriétés
...
\begin{frame}{États quantiques}
    ...
    En informatique quantique on note $\ket{0} = \begin{pmatrix} 1 \\ 0 \end{pmatrix}$ et $\ket{1} = \begin{pmatrix} 0 \\ 1 \end{pmatrix}$ d'où

\end{frame}

\begin{frame}{Diagrammes de décision quantiques}
    \Huge{(Ici, partie sur les diagrammes de décision quantiques)}
...
\begin{frame}{État de l'art}
    ...
    \begin{itemize}
        ...
        \item[+] Nouveauté : \textbf{additivité}
    \end{itemize}
        \onslide<1>{
            \begin{center}
