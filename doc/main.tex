...
This gives us a ring structure for $(\mathcal{A}_0, +, \cdot)$, which we will use just next. For all $\alpha \in \mathcal{A}_0$, we introduce $\mu(\alpha) \in \mathbb{C}$ the \textit{middle} of $\alpha$:
